...
class DynSelectionBenchmark(Benchmark):
    """
    ...
    def function(self):
        def evaluate(D, sol):
            phenotype = DynSelectionBenchmark.to_phenotype(sol, self.split)
    ...
    def genotype_to_map(genotype):
        return np.digitize(genotype, DynSelectionBenchmark.mapping)
...
if __name__ == '__main__':
    ...
    print(gene)
    phenotype = DynSelectionBenchmark.to_phenotype(gene, DynSelectionBenchmark.mapping)
    print(phenotype)
